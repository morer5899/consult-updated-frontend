...
export default function BookingPage() {
  ...
  const paymentAmount = selectedConsultant
    ? (
        (selectedConsultant.hourlyRate || 50) *
  ...
  useEffect(() => {
    const fetchConsultants = async () => {
      ...
      try {
        ...
        setConsultantsError(
          err.message || "Failed to load consultants. Please try again."
        );
      } finally {
          ...
          {consultants.map((consultant) => (
            ...
            >
              <CardHeader className="text-center">
                ...
                <CardDescription>
                  {consultant.specialties?.join(", ") || "General Consultant"}
                </CardDescription>
              </CardHeader>
              <CardContent>
                ...
                <p className="text-sm text-gray-600 mb-4 text-center">
                  {consultant.bio || "Experienced consultant"}
                </p>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">
                    {selectedConsultant?.specialties?.[0] || "Consultant"}
                  </div>
                </div>
              </div>
      ...
      <div className="max-w-md mx-auto">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              You will be charged{" "}
              <span className="font-bold text-blue-600">${paymentAmount}</span>{" "}
          ...
          <CardContent className="space-y-6">
            ...
            <Button
              ...
              disabled={loadingBooking || !razorpayLoaded}
              className="w-full"
            >
              {loadingBooking ? (
                <>
